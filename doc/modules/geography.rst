...
.. currentmodule:: nngt.geography

.. automodule:: nngt.geography
    :no-members:
...
* :func:`~nngt.geography.draw_map` to plot a network on a map
* ``maps``, a dictionary of :obj:`~geopandas.GeoDataFrame` containing data
  ...
  - ``"110m"`` entry contains 177 coutries at 110m resolution,
